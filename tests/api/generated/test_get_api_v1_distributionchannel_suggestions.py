...
@allure.story("GET /api/v1/DistributionChannel/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_distributionchannel_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/DistributionChannel/Suggestions"
