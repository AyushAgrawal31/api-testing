...
@allure.story("GET /api/v1/FlowBuilder/{flowBuilderId}/FlowTasks/Hierarchy")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_flowbuilder_flowbuilderid_flowtasks_hierarchy(request):

    client = APIClient()

    endpoint = "/api/v1/FlowBuilder/{flowBuilderId}/FlowTasks/Hierarchy"
