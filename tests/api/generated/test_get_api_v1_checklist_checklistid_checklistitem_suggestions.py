...
@allure.story("GET /api/v1/Checklist/{checklistId}/ChecklistItem/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_checklist_checklistid_checklistitem_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/Checklist/{checklistId}/ChecklistItem/Suggestions"
