...
@allure.story("GET /api/v1/Account/{accountId}/BusinessUnit")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_businessunit(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/BusinessUnit"
