...
@allure.story("GET /api/v1/Client/{clientId}/ClientXProduct/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_client_clientid_clientxproduct_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/Client/{clientId}/ClientXProduct/Suggestions"
