...
@allure.story("GET /api/v1/Client/Account/{accountId}/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_client_account_accountid_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/Client/Account/{accountId}/Suggestions"
