...
@allure.story("GET /api/v1/Checklist/{checklistId}/ChecklistGroup")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_checklist_checklistid_checklistgroup(request):

    client = APIClient()

    endpoint = "/api/v1/Checklist/{checklistId}/ChecklistGroup"
