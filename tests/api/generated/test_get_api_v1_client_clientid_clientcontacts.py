...
@allure.story("GET /api/v1/Client/{clientId}/ClientContacts")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_client_clientid_clientcontacts(request):

    client = APIClient()

    endpoint = "/api/v1/Client/{clientId}/ClientContacts"
