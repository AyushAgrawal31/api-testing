...
@allure.story("GET /api/v1/Client/{clientId}/ClientAdditionalAttributes")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_client_clientid_clientadditionalattributes(request):

    client = APIClient()

    endpoint = "/api/v1/Client/{clientId}/ClientAdditionalAttributes"
