...
@allure.story("GET /api/v1/Extraction/{id}")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_extraction_id(request):

    client = APIClient()


    # Get real ID
    list_response = client.get("/api/v1/Extraction")
    ...
    sample_id = data[0]["id"]
    endpoint = "/api/v1/Extraction/{id}".replace("{id}", str(sample_id))
