...
@allure.story("GET /api/v1/CalendarEventType/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_calendareventtype_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/CalendarEventType/Suggestions"
