...
@allure.story("GET /api/v1/Bot/directline/token")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_bot_directline_token(request):

    client = APIClient()

    endpoint = "/api/v1/Bot/directline/token"

    response = client.get(endpoint, params={'userId': 'test'})
