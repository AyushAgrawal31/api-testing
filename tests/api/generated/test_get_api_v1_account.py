...
@allure.story("GET /api/v1/Account")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account(request):

    client = APIClient()

    endpoint = "/api/v1/Account"

    response = client.get(endpoint, params={'SortColumn': 'test', 'SortOrder': 'test', 'Title': 'test', 'AccountTypes': 'test', 'AccountStatus': 'test', 'PageNumber': 1, 'PageSize': 1})
