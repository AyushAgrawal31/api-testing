...
@allure.story("GET /api/v1/Account/{accountId}/Extractions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_extractions(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/Extractions"
