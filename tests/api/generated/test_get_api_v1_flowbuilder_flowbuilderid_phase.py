...
@allure.story("GET /api/v1/FlowBuilder/{flowBuilderId}/Phase")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_flowbuilder_flowbuilderid_phase(request):

    client = APIClient()

    endpoint = "/api/v1/FlowBuilder/{flowBuilderId}/Phase"
