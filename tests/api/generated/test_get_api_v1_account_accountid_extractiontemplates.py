...
@allure.story("GET /api/v1/Account/{accountId}/ExtractionTemplates")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_extractiontemplates(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/ExtractionTemplates"
