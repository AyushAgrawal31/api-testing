...
@allure.story("GET /api/v1/ClientXProductStatus/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_clientxproductstatus_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/ClientXProductStatus/Suggestions"
