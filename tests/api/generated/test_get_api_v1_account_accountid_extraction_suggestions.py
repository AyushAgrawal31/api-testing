...
@allure.story("GET /api/v1/Account/{accountId}/Extraction/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_extraction_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/Extraction/Suggestions"
