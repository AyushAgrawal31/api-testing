...
@allure.story("GET /api/v1/Account/{accountId}/Role/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_role_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/Role/Suggestions"
