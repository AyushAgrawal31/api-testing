...
@allure.story("GET /api/v1/App/{appId}/User/{userId}/Todo/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_app_appid_user_userid_todo_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/App/{appId}/User/{userId}/Todo/Suggestions"
