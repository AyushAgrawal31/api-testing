...
@allure.story("GET /api/v1/App/{appId}/Project/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_app_appid_project_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/App/{appId}/Project/Suggestions"
