...
@allure.story("GET /api/v1/Account/{accountId}/ExtractionRequests")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_account_accountid_extractionrequests(request):

    client = APIClient()

    endpoint = "/api/v1/Account/{accountId}/ExtractionRequests"
