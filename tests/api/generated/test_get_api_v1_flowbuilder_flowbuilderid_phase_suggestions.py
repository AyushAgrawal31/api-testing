...
@allure.story("GET /api/v1/FlowBuilder/{flowBuilderId}/Phase/Suggestions")
@allure.severity(allure.severity_level.CRITICAL)
def test_get_api_v1_flowbuilder_flowbuilderid_phase_suggestions(request):

    client = APIClient()

    endpoint = "/api/v1/FlowBuilder/{flowBuilderId}/Phase/Suggestions"
